# Layout - Avaliação de Autismo (TEA) Infantil
...
### A. HERO — "The Unraveling of Understanding"
...
**Typography:**
- Pré-headline: "Jost" Medium 500, 13px, letter-spacing 0.12em, uppercase, cor #3ABFB5 — texto: "AVALIAÇÃO DE AUTISMO (TEA) INFANTIL"
- Headline: "Cormorant Garamond" Italic 300, 64px desktop / 40px mobile, cor #2C3E35, line-height 1.15 — "Avaliação de Autismo (TEA) Infantil"
- Subheadline: "Jost" Regular 400, 17px, cor #5C6B63, line-height 1.75, max-width 480px — "Um olhar cuidadoso e técnico para entender o desenvolvimento e a comunicação do seu filho em Florianópolis."
...
### B. SECAO: O PESO QUE VOCÊ CARREGA — "The Path of Clarity"
...
**Layout:** Container centralizado, max-width 720px. Bloco de texto com padding-left 32px (para criar espaço junto à linha vertical decorativa). O parágrafo final ("Obter clareza sobre o perfil...") recebe destaque tipográfico: fundo #3ABFB5 opacity 0.08, border-left 3px solid #3ABFB5, padding 20px 24px, border-radius 4px.

**Typography:**
- Título: "Cormorant Garamond" Italic 300, 44px desktop / 30px mobile, cor #2C3E35 — "A dúvida sobre o desenvolvimento de um filho gera caminhos complexos para a família"
- Body: "Jost" Regular 400, 17px, cor #5C6B63, line-height 1.8
- Parágrafo de destaque (o que muda): "Jost" Regular 400, 17px, cor #2C3E35 — "Obter clareza sobre o perfil de desenvolvimento do seu filho traz alívio para a dinâmica familiar. Com as respostas certas, é possível traçar um plano de desenvolvimento individualizado, estruturando o suporte adequado tanto no lar quanto no ambiente escolar."
...
### C. SECAO: O ATENDIMENTO DA MARIANA — "The Specialized Care"
...
**Typography:**
- Título: "Cormorant Garamond" Italic 300, 44px, cor #2C3E35, max-width 520px — "Um olhar aprofundado para compreender a singularidade do desenvolvimento infantil"
...
### D. SECAO: SERVIÇOS — "The Journey of Evaluation"
...
**Cards (Etapas da avaliação de autismo):**
1. **Entrevista Inicial com a Família** (card grande) — ícone: duas figuras adultas conversando
2. **Sessões de Avaliação com a Criança** (card grande) — ícone: figura infantil brincando com formas geométricas
3. **Interlocução com a Escola** (card médio) — ícone: documento com carimbo escolar/livro
4. **Entrega do Laudo e Orientação Parental** (card médio) — ícone: prancheta médica / documento com selo de garantia
...
### E. SECAO: AUTORIDADE — "Credentials of Care"
...
**Typography:**
- Label superior: "Jost" Medium 500, 12px, letter-spacing 0.12em, uppercase, cor #3ABFB5 — "ESPECIALISTA"
- Título: "Cormorant Garamond" Italic 300, 52px, cor #FAF8F5, line-height 1.2 — "Mariana Nunes, Psicóloga especialista em Florianópolis"
...
### F. SECAO: COMO FUNCIONA — "Connecting the Dots"
...
**Steps:**
1. **Contato Inicial** — ícone: balão de diálogo com ponto de interrogação
2. **Consulta Inicial** — ícone: duas xícaras/escuta atenta
3. **Processo Investigativo** — ícone: novelo de fio / linha contínua que se abre
...
**Typography:**
- Título: "Cormorant Garamond" Italic 300, 40px, cor #2C3E35 — "Consultório em Florianópolis, SC"
...
**Layout:** Título + subtítulo + formulário centralizado. Formulário com campos: Nome, Telefone (com intl-tel-input), Interesse de atendimento (Família / Criança / Adulto), botão CTA. Campos com estilo: borda 1.5px solid rgba(58,191,181,0.3), border-radius 8px, padding 14px 16px, fundo branco, focus: borda #3ABFB5 com box-shadow `0 0 0 3px rgba(58,191,181,0.15)`.

**Typography:**
- Título: "Cormorant Garamond" Italic 300, 48px desktop / 32px mobile, cor #2C3E35 — "Compreender o desenvolvimento do seu filho é o primeiro passo para apoiá-lo."
- Subtítulo: "Jost" Regular 400, 16px, cor #5C6B63 — "Uma avaliação técnica e humana oferece as diretrizes necessárias para guiar a escola, a família e a equipe de saúde nos cuidados diários. Inicie esse processo hoje mesmo."
- Label dos campos: "Jost" Medium 500, 13px, uppercase, letter-spacing 0.06em, cor #5C6B63
- Botão: "Jost" Medium 500, 15px, uppercase, letter-spacing 0.08em, fundo #3ABFB5, cor branca, padding 16px 40px, border-radius 999px — "Quero agendar avaliação de autismo"
...
### J. FOOTER — "The Continuum of Connection"
...
- **intl-tel-input:** `https://cdn.jsdelivr.net/npm/intl-tel-input@24.6.0/build/css/intlTelInput.css` e `https://cdn.jsdelivr.net/npm/intl-tel-input@24.6.0/build/js/intlTelInput.min.js`
...
- Custom cursor (desktop only): círculo de 20px borda #3ABFB5 opacity 0.6 que segue o mouse com lag (transition 0.12s)
- Botão WhatsApp flutuante: canto inferior direito, fundo #25D366, ícone WhatsApp branco, border-radius 50%, tamanho 56px, box-shadow `0 4px 16px rgba(37,211,102,0.4)`, `animation: pulse 2s infinite`

### Diretiva de qualidade
A nova rota `/autismo/` herda exatamente a mesma infraestrutura visual e funcional da página `/mariana-captura/`, garantindo unidade estética em todo o domínio da profissional.
