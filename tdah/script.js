...
async function handleFormSubmit(e) {
  ...
  try {
    ...
    if (res.ok) {
      ...
      let mensagemWa = '';
      if (interesse === 'Avaliação de TDAH Infantil') {
        mensagemWa = `Olá, me chamo ${primeiroNome} e tenho interesse em agendar uma Avaliação de TDAH Infantil para o meu filho.`;
      } else if (interesse === 'Orientação Parental') {
        mensagemWa = `Olá, me chamo ${primeiroNome} e tenho interesse em uma Orientação Parental sobre TDAH.`;
      } else if (interesse === 'Apoio e Mapeamento Escolar') {
        mensagemWa = `Olá, me chamo ${primeiroNome} e tenho interesse em Apoio e Mapeamento Escolar para o meu filho.`;
      } else {
