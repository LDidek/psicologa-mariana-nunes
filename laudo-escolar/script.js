...
async function handleFormSubmit(e) {
  ...
  try {
    ...
    if (res.ok) {
      ...
      let mensagemWa = '';
      if (interesse === 'Laudo Psicológico para Escola') {
        mensagemWa = `Olá, me chamo ${primeiroNome} e tenho interesse em um Laudo Psicológico para a Escola para o meu filho.`;
      } else if (interesse === 'Avaliação Neuropsicológica Infantil') {
        mensagemWa = `Olá, me chamo ${primeiroNome} e tenho interesse em uma Avaliação Neuropsicológica Infantil para o meu filho.`;
      } else if (interesse === 'Orientação e Mediação Escolar') {
        mensagemWa = `Olá, me chamo ${primeiroNome} e tenho interesse em Orientação e Mediação Escolar para o meu filho.`;
      } else {
        mensagemWa = `Olá, me chamo ${primeiroNome} e tenho interesse em Laudo Psicológico para a Escola.`;
      }
