...
async function handleFormSubmit(e) {
  ...
  try {
    ...
    if (res.ok) {
      ...
      let mensagemWa = '';
      if (interesse === 'Avaliação de Aprendizagem') {
        mensagemWa = `Olá, me chamo ${primeiroNome} e tenho interesse em agendar uma avaliação de dificuldades de aprendizagem para meu filho.`;
      } else if (interesse === 'Intervenção e Apoio Escolar') {
        mensagemWa = `Olá, me chamo ${primeiroNome} e tenho interesse em suporte e intervenção escolar para meu filho.`;
      } else if (interesse === 'Orientação Parental') {
        mensagemWa = `Olá, me chamo ${primeiroNome} e tenho interesse em orientação parental.`;
      } else {
        mensagemWa = `Olá, me chamo ${primeiroNome} e gostaria de tirar algumas dúvidas sobre o atendimento.`;
      }
